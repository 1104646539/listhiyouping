...
package com.lishi.baijiaxing.Address.widget;
...
import com.lishi.baijiaxing.Address.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.base_bg_color));
		// 设置线宽
