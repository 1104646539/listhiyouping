 ...
 */
public class CustomizeGiftBean extends BaseBean {
    private String advertisementUrl1;
    private String advertisementUrl2;
    private List<Integer> advertisementUrls;

    public CustomizeGiftBean() {
    }

    public CustomizeGiftBean(String advertisementUrl1, String advertisementUrl2, List<Integer> advertisementUrls) {
