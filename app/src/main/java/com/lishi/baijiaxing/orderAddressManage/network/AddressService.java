...
public interface AddressService {
    ...
    Observable<AddressList> getAddressList(@Field("a") String addList, @Field("uid") String uid, @Field("token") String token, @Field("type") String type);
    ...
    @FormUrlEncoded
    @POST("/index_api.php?m=add")
    Observable<UpAddress> addAddress(@Field("a") String inAdd, @Field("type") String type, @Field("uid") String uid, @Field("token") String token,
                                     @Field("consigneeName") String consigneeName, @Field("province") String province, @Field("city") String city,
                                     @Field("district") String district, @Field("details") String details, @Field("consigneeNumber") String consigneeNumber,
                                     @Field("isDefalut") String isDefalut);
